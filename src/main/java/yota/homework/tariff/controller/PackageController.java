...
@RestController
@RequestMapping(path = "/sim/{phone-number}")
...
public class PackageController {
    ...
    public ResponseEntity changePackage(@PathVariable("phone-number") Long phoneNumber,
                                        @Valid @RequestBody PackageDto update) {
    ...
    public ResponseEntity activateOrDeactivateSimCard(@PathVariable("phone-number") Long phoneNumber,
